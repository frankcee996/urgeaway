...
const App = (() => {
  ...
  function openRecoveryTimeline() {
    haptic();
    overlayContainer.innerHTML = '';
    overlayContainer.appendChild(renderRecoveryTimeline());
  }

  function openQuickCheckIn(onDone) {
    haptic();
    overlayContainer.appendChild(renderQuickCheckIn((saved) => {
      overlayContainer.innerHTML = '';
